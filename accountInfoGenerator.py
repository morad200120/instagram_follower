...
def generatore_nome_cognome():
    firstName = ["leonardo", "Alan", "Murat", "Azad", "Necati", "Aaron", "Aaron-James", "Aarron", "Aaryan", "Aaryn", "Aayan",
                ...
                "Caedyn", "Cael", "Caelan", "Caelen", "Caethan", "Cahl", "Cahlum", "Cai", "Caidan", "Matteo", 
                "Lorenzo", "Davide", "Federico", "Gabriele", "Simone", "Riccardo", "Tommaso", "Alessandro", "Giovanni", 
                "Vittorio", "Emanuele", "Massimo", "Marco", "Stefano", "Raffaele", "Giulio"]
...
def generatore_username(size=8, chars=string.ascii_lowercase + random.choice(['.', '_'])):
    word_list = [
...
def generatore_password(passwd=None):
    if passwd is None:
...
# Generating a Email
def generatingEmail():
    return ''.join(generatore_username() + '@mail.com')

if __name__=='__main__':
    print(generatore_username(size=12, chars=string.ascii_lowercase + random.choice(['.', '_'])))